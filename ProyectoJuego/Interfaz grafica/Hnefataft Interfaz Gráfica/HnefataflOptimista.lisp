...
(defun leeTablero ()
  (setq mat nil)
  (with-open-file (in "C:/Users/AndrewSauto/Desktop/Hnefataft/TableroInterfaz.txt" :direction :input )
...
(defun escribeResp ()         
    (with-open-file (str "C:/Users/AndrewSauto/Desktop/Hnefataft/Resultados.txt"
               :direction :output
               :if-exists :supersede
